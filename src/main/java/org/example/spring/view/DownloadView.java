...
public class DownloadView {
	     ...
	     // Set ColumnConstraints to make the first and third columns take up equal width
	       ...
	       // verticaldata.getChildren().add(emplyeebox);
	        ...
	        tableView = new TableView<>();
	         ...
	         TableColumn<AttendanceData, String> requiredTimeColumn = createColumn("Required Time", "requiredTime",100);
    ...
    private void exportDataToFile() {
     ...
     // Add header row
        csvContent.append("Employee ID,Name,Office Day,Total Present,Avg Time,Leave,Absent,Holiday,Short Time,Required Time,Extra Time,Entry In Time,Entry Late,Entry Total Late,Exit Ok,Exit Early,Total Extra Time,Office Out Time,Office In Time,Total Time\n");
